        ...
        if len(tmpIPv4pPortList) != len(tmpIPv6pPortList):
            if len(tmpIPv6pPortList) > len(tmpIPv4pPortList):
                if len(x[2]) > 0:
                    ...
                    if len(tmpResultList) > 0:
                        print(
                            x[2] + "\t[" + x[0] + "] - Additional ports on IPv6: " + setColor(", ".join(tmpResultList),
                                                                                              bold, color="red"))
                    else:
                        print(x[2] + "\t[" + x[0] + "]")
                else:
                    ...
                    for y in diffList:
                        if y in tmpIPv6pPortList:
                            tmpResultList.append(str(y))
                    if len(tmpResultList) > 0:
                        print("[" + x[0] + "] - Additional ports on IPv6: " + setColor(", ".join(tmpResultList), bold,
                                                                                       color="red"))
                    else:
                        print("[" + x[0] + "]")
            else:
            ...
            if len(tmpIPv6pPortList) < len(tmpIPv4pPortList):
                if len(x[0]) > 0:
                    ...
                    if len(tmpResultList) > 0:
                        print(
                            x[0] + "\t[" + x[2] + "] - Additional ports on IPv4: " + setColor(", ".join(tmpResultList),
                                                                                              bold, color="red"))
                    else:
                        print(x[0] + "\t[" + x[2] + "]")
                else:
                    ...
                    for y in diffList:
                        if y in tmpIPv4pPortList:
                            tmpResultList.append(str(y))
                    if len(tmpResultList) > 0:
                        print("[" + x[2] + "] - Additional ports on IPv4: " + setColor(", ".join(tmpResultList), bold,
                                                                                       color="red"))
                    else:
                        print("[" + x[2] + "]")
            else:
